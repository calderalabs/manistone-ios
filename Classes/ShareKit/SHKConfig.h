...
#define SHKMyAppName			@"Manistone"
#define SHKMyAppURL				@"http://www.manistone.net"
...
#define SHKFacebookKey				@"YOUR_FACEBOOK_KEY"
#define SHKFacebookSecret			@"YOUR_FACEBOOK_SECRET"
 ...
 */
#define SHKTwitterConsumerKey		@"YOUR_TWITTER_CONSUMER_KEY"
#define SHKTwitterSecret			@"YOUR_TWITTER_SECRET"
#define SHKTwitterCallbackUrl		@"http://www.manistone.net" // You need to set this if using OAuth, see note above (xAuth users can skip it)
